            ...
            <div className="forgot-password">
                <Card className="position-absolute top-50 start-50 translate-middle w-50 m-auto shadow  px-md-5 py-4">
                    <div className='text-center mb-5'>
                        ...
                        <p>Enter your email below to receive your password reset instruction</p>
                    </div>
                    ...
                    >
                        ...
                        >
                            <Input prefix={<MailOutlined className="site-form-item-icon me-2" />} placeholder="Email Id" />
                        </Form.Item>


                        <Form.Item>
                            <Button onClick={setVisible} type="primary" htmlType="submit" className='w-100'>
                                Send Otp
                            </Button>
                        </Form.Item>
